    ...
    <div class="container">
       <div class="row">
            ...
            <div class="col-6" style="background-color:white ; padding:20px ; margin:60px; border-radius: 12px">
                <form action="editar_empleado_sql.php" method="post">
                    <div class="form-group">
                        <label for="idDatosContacto">ID</label>
                        <input type="text" id="idDatosContacto" name="idDatosContacto" readonly value="<?php echo $idDatosContacto; ?>" class="form-control">
                    </div>
                    <div class="form-group">
